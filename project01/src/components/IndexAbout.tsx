        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Embrace eco-friendly style with our carefully curated selection of
              sustainable fashion choices. Each item is timeless, and by
      ...
      <section className="w-full border-t py-12 md:py-16 lg:py-20 xl:py-24">
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Uncover hidden gems and score amazing deals with our collection of
              affordable retro finds. From classic tees to statement pieces,
              weve got everything you need to add a vintage touch to your
